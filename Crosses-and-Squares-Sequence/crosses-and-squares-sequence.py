...
while True:
  ...
  time.sleep(200/1000);
  codebug.draw_sprite(0, 0, build_sprite([0b00000,0b00100,0b01110,0b00100,0b00000]));
  time.sleep(200/1000);
  ...
  codebug.draw_sprite(0, 0, build_sprite([0b00000,0b00000,0b00100,0b00000,0b00000]));
  time.sleep(300/1000);
  codebug.draw_sprite(0, 0, build_sprite([0b00000,0b01110,0b01110,0b01110,0b00000]));
  time.sleep(300/1000);
